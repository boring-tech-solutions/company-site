  ...
  const faqs = [
    {
      ...
      answer:
        "Because the way data is handled has changed faster than the rules most organizations are relying on. In an AI-enabled environment, youth data can be copied, synced, shared, and retained indefinitely—often without clear visibility. Funders and reviewers are increasingly aware of this gap and are asking organizations to demonstrate how governance actually works in practice, not just on paper. Organizations that address this early are finding it easier to maintain funding and credibility. Those that wait are often forced to react under pressure.",
    },
    {
      question: "Are common tools like Dropbox, Google Drive, or shared folders a risk?",
      answer:
        "They can be. While tools like Dropbox and shared cloud drives are convenient, they were not designed for youth data governance. In many organizations, these tools: lack clear, enforceable retention rules; make it difficult to prove who accessed data and when; allow files to be copied, synced, or retained indefinitely; and do not reliably enforce role-based access as staff change. As a result, organizations may unknowingly fall out of alignment with privacy and governance expectations—especially during audits or funding reviews.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes. Many Alberta-based organizations are transitioning away from general-purpose storage for youth data—not because of panic, but because expectations have shifted. Boards and funders now expect systems that enforce governance, not tools that rely on best intentions. YDGC is designed for organizations that want to align with where expectations are going—not where they used to be.",
    },
    {
      question: "Can't we fix this with policies or staff training?",
      answer:
        "Policies and training are important, but they do not scale on their own. Most governance gaps appear when: staff turnover occurs; volunteers rotate; programs overlap; or data lives longer than expected. YDGC turns policy into practice by enforcing governance automatically—reducing reliance on memory and manual checks.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "No. YDGC is designed for lean teams and real-world constraints. Most organizations find that automating governance: reduces administrative burden; simplifies reporting; and frees staff to focus on service delivery.",
    },
    {
      question: "How do we know if this applies to us?",
      answer:
        "The fastest way is to see how your current tools would hold up under a funding or audit review. That's why most organizations start with a demo.",
    },
  ];
  return (
    <div className="min-h-screen bg-background relative">
      ...
      <main className="relative z-10">
        ...
        <section className="relative min-h-screen flex items-center overflow-hidden">
          ...
          <div className="section-container relative py-32">
            <div className="max-w-4xl">
              ...
              <p
                className="text-xl md:text-2xl text-muted-foreground max-w-2xl mb-10 animate-fade-in"
                style={{
                  animationDelay: "0.1s",
                }}
              >
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-lg text-muted-foreground">
                  <p>
                    YDGC is a youth data governance and compliance infrastructure designed specifically for{" "}
                    <strong className="text-foreground">Alberta-based organizations</strong> that work with children and
                    youth.
                  </p>
                  <p>
                    It embeds ethical data handling, accountability, and compliance{" "}
                    <strong className="text-foreground">directly into daily operations</strong>—so governance is built
                    into systems, not left to policy binders.
                  </p>
                </div>
                ...
                <div className="mt-8 p-6 rounded-2xl bg-card border border-primary/20 relative overflow-hidden">
                  ...
                  <p className="text-foreground font-medium pl-4">
                    Delivered as a secure, subscription-based platform—purpose-built for organizations carrying a duty
                    of care.
                  </p>
                </div>
              </div>
          ...
          <div className="section-container">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-16">
                ...
                <h2 className="font-display text-3xl md:text-4xl font-bold mb-6">A New Data Reality</h2>

                <p className="text-lg text-muted-foreground">
                  Youth-serving organizations are operating in a fundamentally different data environment than even a
                  few years ago.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <div className="space-y-8">
                  {[
                    ...
                    <div
                      key={idx}
                      className={`relative flex items-center ${item.side === "right" ? "md:flex-row-reverse" : ""}`}
                    >
              ...
              <div className="mt-8 text-center">
                <p className="text-lg font-medium text-foreground">
                  YDGC replaces uncertainty with structure—helping organizations meet modern expectations without
          ...
          <div className="section-container">
            ...
            <div className="mt-12 text-center">
              <p className="text-lg font-medium text-foreground max-w-3xl mx-auto px-4 py-6 rounded-2xl bg-card border border-border">
                YDGC supports organizations that want to stay ahead—by embedding governance into systems early, rather
                than reacting under pressure later.
              </p>
            </div>
          </div>
        </section>
        ...
        <section
          id="how-it-works"
          className="py-24 bg-gradient-to-br from-emerald-950/20 via-card to-card border-t border-emerald-500/10"
        >
          <div className="section-container">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 text-primary text-sm font-medium uppercase tracking-widest mb-6">
              ...
              <h2 className="font-display text-3xl md:text-4xl font-bold mb-4">What YDGC Does</h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
        ...
        <section className="py-24 bg-gradient-to-br from-rose-950/20 via-card to-card border-t border-rose-500/10">
          <div className="section-container">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h2 className="font-display text-3xl md:text-4xl font-bold mb-6">Ethics at the Core</h2>

              <p className="text-lg text-muted-foreground mb-4">
                YDGC is shaped by direct experience working alongside children, youth, and vulnerable communities in
                Alberta.
              </p>
              <p className="text-lg text-muted-foreground mb-8">
                This includes long-term volunteer mentorship with{" "}
                <strong className="text-foreground">Big Brothers Big Sisters of Edmonton</strong> and career mentorship
                through programs such as <strong className="text-foreground">All In For Youth</strong>.
              </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {ethicsPrinciples.map((principle, index) => (
                  <div
                    key={index}
                    className="flex flex-col items-center gap-3 p-4 rounded-xl bg-background border border-border hover:border-primary/30 transition-colors group"
                  >
        ...
        <section className="py-24 bg-gradient-to-br from-cyan-950/20 via-background to-card border-t border-cyan-500/10">
          <div className="section-container">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h2 className="font-display text-3xl md:text-4xl font-bold mb-6">Designed With Funders in Mind</h2>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                {funderBenefits.map((benefit, index) => (
                  <div
                    key={index}
                    className="p-6 rounded-2xl bg-card border border-border hover:border-primary/30 transition-all duration-300 hover:-translate-y-1 group"
                  >
                    <benefit.icon
              ...
              <div className="p-8 rounded-3xl bg-card border border-border">
                <h3 className="font-display text-lg font-semibold mb-6">
                  Well-suited for organizations engaging with:
                </h3>
        ...
        <section className="py-24 bg-gradient-to-br from-primary/15 via-card to-card border-t border-primary/20">
          <div className="section-container">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h2 className="font-display text-3xl md:text-4xl font-bold mb-6">Why Boring Tech Solutions</h2>
              ...
              <div className="grid sm:grid-cols-3 gap-8">
                {[
                  ...
                  <div
                    key={index}
                    className="group relative p-8 rounded-3xl bg-background border border-border hover:border-primary/30 transition-all duration-300 hover:-translate-y-2 overflow-hidden"
                  >
                    <div
        ...
        <section className="py-32 relative overflow-hidden">
          ...
          <div className="section-container relative">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h2 className="font-display text-4xl md:text-5xl font-bold mb-6">Build Trust Into Your Data Systems</h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button size="lg" variant="outline" className="text-lg px-8 py-6" asChild>
                  <a href="/contact">Discuss Pilots or Partnerships</a>
                </Button>
              </div>
            </div>
          </div>
