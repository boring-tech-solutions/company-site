            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8 animate-fade-in">
                ...
                <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight">
                  ...
                  <span className="text-primary">Youth Information</span>
                </h1>
                ...
                >
                  ...
                  >
                    <CardContent className="h-full flex flex-col items-center justify-center p-6 text-center">
                      {!flippedCards.includes(index) ? (
                        <>
                          <card.icon className="text-primary mb-4" size={48} />
                        ...
                        <>
                          <AlertTriangle className="text-destructive-foreground mb-4" size={48} />
          ...
          <div className="section-container relative z-10">
            <div className="text-center mb-16">
              ...
              <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mt-2">
                ...
                <span className="text-destructive">Big Problems</span>
              </h2>
            </div>
                ...
                >
                  <CardContent className="p-8 text-center">
                    <div className="w-16 h-16 bg-destructive/20 rounded-xl flex items-center justify-center mx-auto mb-4">
                      <scenario.icon className="text-destructive" size={28} />
                    </div>
                    <p className="text-lg font-medium text-foreground">
                      {scenario.text}
                    </p>
        ...
        <section className="py-24 bg-surface-teal-light relative overflow-hidden">
          ...
          <div className="section-container relative z-10">
            <div className="text-center mb-16">
              ...
              <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mt-2">
                A Simple System to{" "}
                <span className="text-primary">Protect Youth Information</span>
              </h2>
            </div>
                  ...
                  <CardContent className="p-8">
                    <div className="flex items-start gap-4">
                      <div className="w-14 h-14 bg-primary/20 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-primary/30 transition-colors">
                        <item.icon className="text-primary icon-animate" size={28} />
                      </div>
                      <div>
          ...
          <div className="section-container relative z-10">
            <div className="text-center mb-16">
              ...
              <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mt-2">
                ...
                <span className="text-primary">Already Using YDGC</span>
              </h2>
            </div>
                ...
                <Card key={index} className="card-premium group">
                  <CardContent className="p-8 text-center">
                    <div className="w-20 h-20 bg-primary/20 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:bg-primary/30 transition-colors">
                      <card.icon className="text-primary icon-animate" size={36} />
                    </div>
        ...
        <section className="py-24 bg-surface-navy relative">
          ...
          <div className="section-container relative z-10">
            <div className="text-center mb-16">
              ...
              <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mt-2">
                What You Get With{" "}
                <span className="text-primary">YDGC</span>
              </h2>
            </div>
          ...
          <div className="section-container relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mt-2 mb-8">
                ...
                <span className="text-primary">Feels Right for You</span>
              </h2>
              
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-10">
                <Button size="lg" className="group text-lg px-6 py-6">
                  <Play className="mr-2" size={20} />
                  Watch Full Demo
                </Button>
                <Button size="lg" className="group text-lg px-6 py-6">
