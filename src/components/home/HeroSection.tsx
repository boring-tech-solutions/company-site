    ...
    <section className="relative min-h-screen flex flex-col overflow-hidden pt-20">
      ...
      <div className="section-container relative z-10 flex-1 flex items-center justify-center px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-3xl md:text-5xl lg:text-7xl font-bold mb-4 md:mb-6 animate-fade-in delay-100 font-sans" style={{ lineHeight: '1.4' }}>
            Calm Precision in a{" "}
      ...
      <div className="section-container relative z-10 pb-8 md:pb-12 px-6">
        <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center items-center animate-fade-in delay-300">
          <Button size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90 text-base md:text-lg px-6 md:px-8 py-5 md:py-6 group glow-gold w-full sm:w-auto" asChild>
