  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        charcoal: { DEFAULT: "hsl(var(--charcoal))", deep: "hsl(var(--charcoal-deep))", light: "hsl(var(--charcoal-light))" },
      },
      ...
      keyframes: {
        ...
        glow: { "0%, 100%": { boxShadow: "0 0 20px hsl(48 100% 62% / 0.2)" }, "50%": { boxShadow: "0 0 40px hsl(48 100% 62% / 0.4)" } },
      },
      animation: {
